...
(defsystem kappa
  ...
  :components ((:module "src"
                ...
                ((:file "kappa")
                 ...
                 (:file "converter.1.0" :depends-on ("define" "define.1.0" "converter"))
                 (:file "define.1.3" :depends-on ("annot"))
                 (:file "converter.1.3" :depends-on ("define" "define.1.3" "converter" "util"))
